...
| 字段 | 说明 | 示例 |
|------|------|------|
| 堡垒机用户名 | 登录堡垒机网页的账号 | `liuguanyu` |
| 堡垒机密码 | 登录堡垒机网页的密码 | `Cloudwise_1234567` |
| 服务器密码 | 目标 Windows Server 的登录密码 | `123.com` |
| 服务器账号 | 目标服务器的用户名（默认同堡垒机用户名） | `liuguanyu` |
| 服务器 IP | 目标服务器的 IP 地址 | `10.237.35.254` |
